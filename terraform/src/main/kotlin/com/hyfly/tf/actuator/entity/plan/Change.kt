...
class Change {
    ...
    private val afterUnknown: Any? = null
    ...
    private val beforeSensitive: Any? = null

    @JSONField(name = "after_sensitive")
    private val afterSensitive: Any? = null
    ...
    private val importing: Importing? = null
    ...
    private val generatedConfig: String? = null
}
